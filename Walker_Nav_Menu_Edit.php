	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
	    ...
	    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
	        ...
	        <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
	            ...
	            <p class="field-mega_menu description description-thin">
	            	<label for="edit-menu-item-mega_menu-<?php echo $item_id; ?>">
	                    <?php _e( 'Mega Menu' ); ?><br />
	                    <input type="checkbox" id="edit-menu-item-mega_menu-<?php echo $item_id; ?>" class="widefat code edit-menu-item-mega_menu" name="menu-item-mega_menu[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->mega_menu ); ?>" />
	                </label>
	            </p>
